...
module IRTS.MyCodegenC (codegenC, register) where
...
import Paths_idris_codegen_ext
...
register = do
  ...
  registerLibFlag "-lmyidris_rts" 81
#ifdef IDRIS_GMP
  registerLibFlag "-lgmp" 99
#endif
  registerLibFlag "-lpthread" 100
  registerInfoString "My C RTS Dir" dir
  registerCodeGenerator "x" codegenC
